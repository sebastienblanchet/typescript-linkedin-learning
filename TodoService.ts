...
export default class TodoService implements ITodoService {
  ...
  // exactly same design pattern as python
  // all this is doing is defining a new prototype which wraps the original method
  @log
  add(input): Todo {
...
// decorator function
// takes in these args things always
// es5 proposal, might not actually be implemented
// this is seen in the tsconfig file flag:
